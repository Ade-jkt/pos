        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Form Data Pembelian</h3>
              <a class="btn btn-primary" 
              style="margin-left: 10px;line-height: 17px;" href="?page=tambah_pembelian">Tambah</a>
            </div>
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                $sql = mysqli_query($koneksi, "SELECT * FROM pembelian ORDER BY id ASC") or die(mysqli_error($koneksi));
