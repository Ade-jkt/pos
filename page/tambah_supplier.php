          ...
          <div class="card card-outline card-primary">
            ...
            <?php
              if(isset($_POST['simpan'])){
                ...
                $cek = mysqli_query($koneksi, "SELECT * FROM supplier WHERE nama_supplier='$nama'") or die(mysqli_error($koneksi));
                
                if(mysqli_num_rows($cek) == 0){
                  $sql = mysqli_query($koneksi, "INSERT INTO supplier(nama_supplier, alamat, email, telp) VALUES('$nama', '$alamat', '$email', '$telp')") or die(mysqli_error($koneksi));
                  
                  if($sql){
                    echo '<script>alert("Berhasil menambahkan data."); document.location="?page=supplier";</script>';
                  }else{
            ...
            ?>
              ...
              <form method="post" action="">
                ...
                <div>
                  ...
                  <a class="btn btn-danger" style="line-height: 18px;" href="?page=supplier">Kembali</a>
                </div>
              </form>
            </div>
          </div>
