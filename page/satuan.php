          ...
          <div class="card">
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                $sql = mysqli_query($koneksi, "SELECT * FROM satuan ORDER BY id ASC") or die(mysqli_error($koneksi));
                  ...
                  while($data = mysqli_fetch_assoc($sql)){
                    ...
                    <tr>
                      ...
                      <td style="text-align: center;">
                        <a href="index.php?page=edit_satuan&id='.$data['id'].'" class="btn btn-primary fa fa-edit" style="line-height: 17px;"> Edit</a>
                        <a href="index.php?page=hapus_satuan&id='.$data['id'].'" class="btn btn-danger fa fa-edit" style="line-height: 17px;" onclick="return confirm(\'Yakin ingin menghapus data ini?\')"> Hapus</a>
                      </td>
                    </tr>
                    ';
                    $no++;
