          ...
          <div class="card card-outline card-primary">
            ...
            <?php
              ...
              if(isset($_GET['id_pelanggan'])){
                ...
                $select = mysqli_query($koneksi, "SELECT * FROM pelanggan WHERE id_pelanggan='$id'") or die(mysqli_error($koneksi));
            ...
            <?php
              ...
              if(isset($_POST['simpan'])){
                ...
                $sql = mysqli_query($koneksi, "UPDATE pelanggan SET nama_pelanggan='$nama', alamat='$alamat', email='$email', telp='$telp' WHERE id_pelanggan='$id'") or die(mysqli_error($koneksi));
